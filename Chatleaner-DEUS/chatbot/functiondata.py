...
class FunctionData:
    ...
    def update_user_name_and_reply_deus(self, new_name):
        user_name = self.chat_session.user_name
        ...
        if new_name and new_name.strip() != '':
            if user_name:
                if new_name.lower() != user_name.lower():
                    ...
                    return "Thank you, {}, for assuring me your name. My name is Deus.".format(user_name)
            else:
                self.chat_session.user_name = new_name
                return "Thank you, {}. BTW, my name is Deus.".format(new_name)
        else:
            return "My name is Deus. Thanks."
...
def call_function(func_info, knowledge_base=None, chat_session=None, para_list=None,
    ...
    func_dict = {
        ...
        'update_user_name_and_reply_deus': func_data.update_user_name_and_reply_deus,
